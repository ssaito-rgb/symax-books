  ...
  return (
    <div className="flex flex-col gap-4">
      <p className="text-sm text-gray-600">
        領収書の写真・PDFをアップロードした際に、OCRで読み取った内容をもとにGoogle Driveへ自動保存するための連携です。アプリが作成したファイルのみにアクセスできる限定的な権限（drive.file）と、PDFのOCR処理に使うGoogle Cloud全般への権限（cloud-platform、あなたが既に持っているこのGCPプロジェクトのオーナー権限をそのまま使います）を要求します。
      </p>
